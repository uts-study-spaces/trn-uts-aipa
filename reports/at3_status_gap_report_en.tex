...
\begin{enumerate}
  ...
  \item \textbf{Avoid overclaiming:} describe LLMs, transformers, and GenAI as future work unless they are actually implemented.
...
\addlinespace
Multiple AI paradigms & \partialstatus & Mainly report; brief slide mention & \textbf{Frame as an improvement opportunity.} Implemented paradigms include supervised NLP, probabilistic Naive Bayes baseline, symbolic routing/escalation rules, explainability, and template summarisation. A stronger SLO4 component is not implemented, so LLMs/transformers should be described as future work unless added. \\
\addlinespace
Theoretical justification & \partialstatus & Mainly report & \textbf{Frame as in progress.} The slides include references for TF-IDF, Linear SVM, explainability, and responsible AI. The final report should turn these into academic justification and compare trade-offs against alternatives such as transformer embeddings or LLM-based triage. \\
\addlinespace
...
Add an ``implemented vs future work'' table & 20 minutes & Avoids overclaiming LLM/GenAI and demonstrates critical thinking. \\
